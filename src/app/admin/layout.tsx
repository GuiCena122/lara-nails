  ...
  return (
    <div className="flex flex-col md:flex-row min-h-screen bg-[#251f1f] text-white">
      ...
      <aside className="hidden md:flex w-64 border-r border-white/10 flex-col fixed inset-y-0 left-0 bg-[#251f1f] z-40">
        <div className="p-8">
          <Link href="/" className="text-xl font-serif font-bold text-[#e76f51]">
            Lara<span className="italic font-light text-white"> Pro</span>
          </Link>
        </div>
        ...
        <div className="p-4 border-t border-white/10">
          <button
            ...
            className="flex items-center gap-3 px-4 py-3 text-rose-400 hover:bg-rose-400/10 rounded-xl transition-all w-full text-sm font-medium"
          >
      ...
      <main className="flex-1 flex flex-col md:ml-64 pb-24 md:pb-0">
        <header className="h-14 md:h-16 border-b border-white/10 flex items-center justify-between px-4 md:px-8 sticky top-0 bg-[#251f1f]/80 backdrop-blur-md z-30">
      ...
      <nav className="md:hidden fixed bottom-3 left-3 right-3 bg-[#251f1f]/95 backdrop-blur-xl border border-white/10 rounded-[2rem] z-50 p-2">
          ...
          {menuItems.map((item) => (
            <Link
              ...
              className={cn(
                ...
                activeTab === item.id ? 'text-[#e76f51]' : 'text-gray-500 hover:text-gray-300'
              )}
            >
